...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().sorted(Comparator.comparingInt(Customer::getAge)).map(Customer::getAge);
    ...
    public void descSortByAge() {
        ...
        Stream<Integer> sortedAgeStream = customerList.stream().sorted((o1, o2) -> descOrder.compare(o1.getAge(), o2.getAge())).map(Customer::getAge);
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Integer> descOrder = ((o1, o2) -> o2 - o1);
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((o1, o2) -> descOrder.compare(o1.getBudget(), o2.getBudget())).map(Customer::getName).limit(3);
